...
Source: Smart Location Database (Version 2.0, EPA) Level of Detail : Census Block Group Level (~220,000 block groups across the U.S.) Dimensions: Approximately 220,000 rows (one per block group), 100+ columns (variables)
...
Calculated fields: Region_EastWest: Categorizes each row as “East” or “West” based on State FIPS codes. IF [Statefp] IN (9, 23, 25, 33, 34, 36, 42, 44, 50, 1, 10, 11, 12, 13, 24, 37, 45, 47, 51, 54) THEN "East" ELSE "West" END Density Category: Groups population density into Low, Medium, and High. IF [D1B] < 100 THEN "Low" ELSEIF [D1B] < 300 THEN "Medium" ELSE "High" END
